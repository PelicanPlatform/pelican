...
// performed here; identity resolution happens in resolveS3TargetIdentity.
...
func isS3NotFound(err error) bool {
	...
	// Some S3-compatible services return a generic API error with a 404
	// status; the smithy error text includes "StatusCode: 404".
