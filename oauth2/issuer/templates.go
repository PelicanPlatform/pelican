...
// authorizeConsentTemplate is the authorization grant consent page.
// Converted from oa4mp/resources/jsp-overrides/authorize-remote-user.jsp
const authorizeConsentTemplate = `<!DOCTYPE html>
<html>
<head>
