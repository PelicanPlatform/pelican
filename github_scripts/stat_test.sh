...
federationServe="./pelican-server --config ${PELICAN_CONFIG} serve --module director --module registry --module origin --port 0 || :"
...
TOKEN=$(./pelican-server --config "${PELICAN_CONFIG}" origin token create --audience "https://wlcg.cern.ch/jwt/v1/any" --issuer "${SERVER_EXTERNAL_WEB_URL}/api/v1.0/origin" --scope "web_ui.access" --subject "bar" --lifetime 3600)
