...
./pelican object put input.txt osdf:///test/input.txt -d -t tmp_jwt -l putOutput.txt
...
./pelican object get osdf:///test/input.txt output.txt -d -t tmp_jwt -l getOutput.txt
