...
Before proceeding, we recommend reading through the [Core Concepts and Terminology](./core-concepts.mdx) page to get familiar with terms used in the documentation.
