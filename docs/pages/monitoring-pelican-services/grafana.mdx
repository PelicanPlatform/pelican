...
> Pelican also provides a dashboard template for Pelican Director server. Download the template file from [here](https://github.com/PelicanPlatform/pelican/blob/main/docs/public/director-dashboard-template.json).
