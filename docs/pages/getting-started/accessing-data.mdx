...
To learn our terminology and about Pelican's architecture, we recommend you read through our [About Pelican](../index.mdx) page to learn how Pelican works and how it can be useful to you.
...
**For Users:**
- Learn more advanced client-usage from our [Client Usage](../getting-data-with-pelican/client.mdx) page.
