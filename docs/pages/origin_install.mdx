...
Grab the appropriate binary for your system from the [pelican repository](https://github.com/PelicanPlatform/pelican/releases). For more details, see (the client installation instructions)[/pelican/install.mdx]
...
![picture of an origin startup terminal prompt with the initializaiton code](/pelican/origin_start.png)
...
![invalid certificate warning image](/pelican/invalid_certificate.png)
...
![metrics page](/pelican/metrics_view.png)
