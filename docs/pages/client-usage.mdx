...
Or:
```console
pelican object get -f https://osg-htc.org pelican:///ospool/uc-shared/public/OSG-Staff/validation/test.txt downloaded-testfile.txt
```
...
- **-l or --log**: Takes a string that specifies a file location to output the pelican logs to rather than stderr
