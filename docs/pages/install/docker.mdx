...
There are another ways to pass environment variables to a Docker container, see details in [Docker documentation](https://docs.docker.com/reference/cli/docker/container/run/#env).
...
1. Prepare an `yaml` file on the host machine:
