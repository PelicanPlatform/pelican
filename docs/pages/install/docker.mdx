...
This document explains how to run a Pelican server using Pelican docker image. If you want to use Pelican client functionalities, such as download or upload an object, refer to [install page](../install.mdx) to download and install a Pelican binary instead.
