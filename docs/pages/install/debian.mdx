...
3. In the list of download candidates, copy the link to `pelican-x.x.x-1.amd64.deb` if you select **AMD64**, or `pelican-x.x.x-1_arm64.deb` if you select **ARM64**, where `x.x.x` is the version number.
