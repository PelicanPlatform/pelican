...
2. In **Operating System** section, select **Linux**. In **Architectures** section, select **AMD64** or **ARM64** depending on the architecture of your machine.

3. In the list of download candidates, copy the link to `pelican_x.x.x_p1_x86_64.apk` if you select **AMD64**, or `pelican_x.x.x_p1_aarch64.apk` if you select **ARM64**, where `x.x.x` is the version number.
