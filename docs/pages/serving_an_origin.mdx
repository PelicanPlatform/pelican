...
The [Pelican](http://pelicanplatform.org/) origin exposes a storage backend such as POSIX or S3 to other members of the federation. This will give you the steps to install XRootD as well as how to install Pelican and start up an origin.
