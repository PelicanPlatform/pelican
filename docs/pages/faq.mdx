...
Both the Pelican Platform and HTCSS are open-source software techonologies whose development is led by the Center for High Throughput Computing (CHTC) at the University of Wisconsin-Madison,
