...
Both the Pelican Platform and HTCSS are open-source softwares whose development is led by the Center for High Throughput Computing (CHTC) at the University of Wisconsin-Madison, 
...
While the funding for developing these softwares comes from different sources, there is a lot of overlap of the staff that are involved in the development of these softwares. 

The flagship instance of HTCSS is the OSPool, a nation-wide scientific and research computing platform based in the U.S. 
The need for managing the efficient movement of large data within the OSPool led to the creation of the OSDF. 
...
See [Choosing a Namespace Prefix](/docs/pages/federating-your-data/choosing-namespaces) for more information.
...
### I am using __ computer with __ operating system - can I still use Pelican to download objects?
...
Visit [Getting Started - Accessing Data](/docs/pages/getting-started/accessing-data) to get started with the Pelican CLI.
To learn more about the Pelican Clients, visit [Getting Data With Pelican](/docs/pages/getting-data-with-pelican).
