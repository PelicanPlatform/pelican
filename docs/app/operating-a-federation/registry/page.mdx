...
For the full registration lifecycle — how services auto-register as `Incomplete`, how operators claim and own their registrations, and how review notes reach them — see [Service Registration & Ownership](../federating-your-data/registration.mdx).
