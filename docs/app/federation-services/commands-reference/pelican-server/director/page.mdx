---
title: pelican server director
---

## pelican-server director
...
* [pelican-server director serve](/federation-services/commands-reference/pelican-server/director/serve/)	 - serve the director service
