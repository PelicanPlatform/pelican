---
title: pelican server registry
---

## pelican-server registry
...
* [pelican-server registry serve](/federation-services/commands-reference/pelican-server/registry/serve/)	 - serve the registry
