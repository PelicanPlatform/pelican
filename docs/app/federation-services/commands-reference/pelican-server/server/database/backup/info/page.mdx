---
title: pelican server server database backup info
---

## pelican-server server database backup info
...
```
pelican-server server database backup info [backup-file] [flags]
```
