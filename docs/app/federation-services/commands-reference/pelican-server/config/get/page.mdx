---
title: pelican server config get
---

## pelican-server config get
...
```
pelican-server config get [arguments] [flags]
```
...
```
  ...
  -v, --verbose              Show the source of each configuration value (e.g. config file path, environment variable)
```
