...
Pelican servers use `https` for serving its web UI, handling objects transfer requests and internal http requests. `https` requires a set of credential files in place to work. For details on how to set up the TLS credentials, refer to [Federating Your Data](/sharing-your-data/federating-your-data#prepare-tls-credentials) page.
...
* [Serve a Pelican Registry](/federation-services/registry)
* [Serve a Pelican Director](/federation-services/director)
* [Serve a Pelican Cache](/federation-services/cache)
