...
> **Note**: Pelican Debian package does not contain dependencies such as `XRootD` for Pelican servers. Use [Pelican Docker image](./docker) instead if you want to serve a Pelican server.

### Install the Pelican using a DEB package

1. Navigate to [Pelican download page](../install#download-pelican-binary) and select the Pelican DEB you want to install.
