...
This document explains how to run a Pelican server using Pelican docker image. If you want to use Pelican client functionalities, such as to download or upload an object, refer to the [install page](../install) to download and install a Pelican binary instead.
...
<Callout type="info">
Some of Pelican configuration parameters with the `object` type can not be passed as environment variables, such as [GeoIPOverrides](../configuration#GeoIPOverrides) and [Origin.Exports](../configuration##Origin-Exports). For these parameters, use a configuration file instead.
</Callout>
...
**Configuration**: To customize the path, see the [`IssuerKeysDirectory`](../configuration#IssuerKeysDirectory) parameter.
...
**Configuration**: To customize the path, see the [`Server.DbLocation`](../configuration#Server-DbLocation) parameter.
...
**Configuration**: To customize the path, see the [`Server.UIPasswordFile`](../configuration#Server-UIPasswordFile) parameter.
...
**Configuration**: To customize paths, see [`Server.TLSCertificateChain`](../configuration#Server-TLSCertificateChain), [`Server.TLSKey`](../configuration#Server-TLSKey), and [`Server.TLSCACertificateFile`](../configuration#Server-TLSCACertificateFile) parameters.
...
**Configuration**: To customize the path, see the [`Server.SessionSecretFile`](../configuration#Server-SessionSecretFile) parameter.
...
**Configuration**: To send service logs to a file rather than stdout/stderr, see the [`Logging.LogLocation`](../configuration#Logging-LogLocation) parameter.
...
**Configuration**: To customize the path, see the [`Monitoring.DataLocation`](../configuration#Monitoring-DataLocation) parameter.
...
**Configuration**: To customize paths, see [`OIDC.ClientIDFile`](../configuration#OIDC-ClientIDFile) and [`OIDC.ClientSecretFile`](../configuration#OIDC-ClientSecretFile) parameters.
...
**Configuration**: To customize the path, see the [`Origin.DbLocation`](../configuration#Origin-DbLocation) parameter.
...
**Configuration**: Use the [`Origin.Exports`](../configuration#Origin-Exports) parameter to define exports.
...
**Default Path**: Configured via the [`Origin.Exports`](../configuration#Origin-Exports) parameter.
...
**Configuration**: Set [`Cache.StorageLocation`](../configuration#Cache-StorageLocation) to point to the mounted cache storage.
...
**Configuration**: To customize paths, see [`Director.GeoIPLocation`](../configuration#Director-GeoIPLocation) and [`Director.MaxMindKeyFile`](../configuration#Director-MaxMindKeyFile) parameters.
