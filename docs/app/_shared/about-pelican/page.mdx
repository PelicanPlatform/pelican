...
Before proceeding, we recommend reading through the [Core Concepts and Terminology](./about-pelican/core-concepts) page to get familiar with terms used in the documentation.
