...
with data using the Pelican command line client at [Accessing Data](/accessing-your-data/accessing-data).

For a more complete walkthrough of Pelican's clients, see [Getting Data with Pelican](/accessing-your-data/overview), which discusses each of Pelican's
...
For more information on the authorization process, see [Getting Data with Pelican](/accessing-your-data/overview).
...
For a more complete discussion of Origins and how you can run your own, see [Federating Your Data](/sharing-your-data/federating-your-data).
...
If you are interested in contributing a cache to an existing federation, see [Operating a Federation/Cache](/federation-services/cache) for the general
process.
...
You can find more information about operating these services in the [Operating a Federation](/federation-services/overview) section. Information specific to
Directors can be found in the sub page titled [Director](/federation-services/director) while information for Registries can be found in the sub page
titled [Registry](/federation-services/registry).
