...
* [Pelican CLI](#pelican-cli): problems using the [Pelican CLI](/accessing-your-data/command-line) client, specifically.
* [Pelican HTCondor Plugin](#pelican-htcondor-plugin): problems using [Pelican's HTCondor file transfer plugin](/accessing-your-data/overview#pelicans-htcondor-plugin), specifically.
...
among other things. (For more information, see [About Pelican](./about-pelican) and [Getting Data with Pelican](/accessing-your-data/overview).)
...
This section discusses common errors when working with the [Pelican CLI](/accessing-your-data/command-line) client.
