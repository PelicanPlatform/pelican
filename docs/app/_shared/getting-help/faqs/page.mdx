...
See [Choosing a Namespace Prefix](/sharing-your-data/federating-your-data/choosing-namespaces) for more information.
...
Visit [Getting Started - Accessing Data](/accessing-your-data/accessing-data) to get started with the Pelican CLI.
To learn more about the Pelican Clients, visit [Getting Data With Pelican](/accessing-your-data/overview).
...
```bash
pelican-server key create --private-key /path/to/your/private-key.pem
```
...
```bash
pelican-server key create --private-key /path/to/your/private-key.pem --public-key /path/to/output/public-key.jwks
```
...
For more information about managing Pelican keys, see [Managing Administrator Credentials](/sharing-your-data/admin-credentials).
