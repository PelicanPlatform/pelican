...
Configuration options listed in the [configuration parameters table](/accessing-your-data/configuration) are typically set via the `pelican.yaml` file.
...
[Environment Variable Configuration](/accessing-your-data/configuration#environment-variable-configuration).
