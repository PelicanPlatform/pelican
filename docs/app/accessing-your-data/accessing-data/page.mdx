...
To learn our terminology and about Pelican's architecture, we recommend you read through the [About Pelican](/accessing-your-data/about-pelican) page and [Core Concepts and Terminology](/accessing-your-data/about-pelican/core-concepts) page to learn how Pelican works and how it can be useful to you.
...
**For Users:**
- Learn more advanced client-usage from the [Pelican Client Usage](/accessing-your-data/command-line) page.
- Learn how to federate your data to a Pelican federation with the [Pelican Origin](/sharing-your-data/federating-your-data)

**For Admins:**
- Learn how to operate your own [Pelican Federation](/federation-services/overview)
