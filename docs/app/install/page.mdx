...
For containerized server deployments we recommend our [Pelican Docker images](./install/docker.mdx), which ship both binaries.
...
* [Conda-forge (Linux, macOS, Windows)](./install/conda.mdx)
...
* [Install Pelican via Conda-forge (Linux, macOS, Windows)](./install/conda.mdx)
