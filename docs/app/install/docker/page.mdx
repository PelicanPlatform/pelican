...
Registries do not require persisting data outside the directories/files discussed in the ["Data That Should Persist for All Server Types"](./docker#data-that-should-persist-for-all-server-types) section.
