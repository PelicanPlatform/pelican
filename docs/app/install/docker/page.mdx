...
For Origins and Caches, this is the source of the "namespace is registered with a different key" error.
...
In addition to the common data, Registries need to persist:
