...
1. In the list of download candidates, copy the link to `pelican-x.x.x-1.x86_64.rpm` if you select **X86_64**, or `pelican-x.x.x-aarch64.rpm` if you select **ARM64** (ARM), where `x.x.x` is the version number.
