---
title: pelican origin issuer client
---
...
* [pelican origin issuer client create](/commands-reference/origin/issuer/client/create/)	 - Create a new OIDC client
* [pelican origin issuer client delete](/commands-reference/origin/issuer/client/delete/)	 - Delete an OIDC client
* [pelican origin issuer client list](/commands-reference/origin/issuer/client/list/)	 - List all OIDC clients
* [pelican origin issuer client update](/commands-reference/origin/issuer/client/update/)	 - Update an existing OIDC client
