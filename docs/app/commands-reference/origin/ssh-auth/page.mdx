...
* [pelican origin ssh-auth login](/commands-reference/origin/ssh-auth/login/)	 - Interactive keyboard-interactive authentication via WebSocket
* [pelican origin ssh-auth status](/commands-reference/origin/ssh-auth/status/)	 - Check SSH connection status of an origin
* [pelican origin ssh-auth test](/commands-reference/origin/ssh-auth/test/)	 - Test SSH POSIXv2 connection and helper lifecycle
