...
* [pelican job cancel](/commands-reference/pelican/job/cancel/)	 - Cancel a transfer job
* [pelican job list](/commands-reference/pelican/job/list/)	 - List all transfer jobs
* [pelican job status](/commands-reference/pelican/job/status/)	 - Get the status of a transfer job
