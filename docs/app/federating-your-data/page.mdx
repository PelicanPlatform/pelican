...
## Contributing to the OSDF
If you are planning to make your data available via the OSDF, we encourage you to consult the OSDF documentation for system administrators here: [osg-htc.org/docs/data/osdf/overview/](https://osg-htc.org/docs/data/osdf/overview/).
