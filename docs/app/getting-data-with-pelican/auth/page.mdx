...
For a more technical walkthrough of Pelican's authorization framework including how "authorization" differs from "authentication", see "[Advanced Usage/Pelican's Authorization System](../../advanced-concepts/auth)".
...
Instead, Pelican uses [authorization tokens](../../advanced-concepts/auth#tokens) to decide whether to grant or deny object access.
...
Before continuing, it's recommended that you have an overview understanding of the concepts discussed in "[Advanced Usage/Pelican's Authorization System](../../advanced-concepts/auth)" because this command lets you build arbitrary data access tokens.
