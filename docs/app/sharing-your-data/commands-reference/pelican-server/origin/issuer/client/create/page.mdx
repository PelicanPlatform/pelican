...
* [pelican-server origin issuer client](/sharing-your-data/commands-reference/pelican-server/origin/issuer/client/)	 - Manage OIDC clients for the origin's embedded issuer
