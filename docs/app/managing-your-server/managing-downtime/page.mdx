...
1. Pelican immediately marks the server as being in downtime.
2. The Director stops redirecting new clients to this Origin/Cache.
3. Existing in-flight transfers are allowed to continue.
4. The downtime remains in effect until `Xrootd.ShutdownTimeout` (default: 1m) expires and Pelican fully exits.
