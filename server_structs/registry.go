...
// BeforeCreate GORM hook to auto-generate Server ID only when not provided.
// For server auto-registrations via CLI, the server should generate its own ID.
// For manual web UI registrations, the ID will be auto-generated by the Registry.
