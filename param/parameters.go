...
var runtimeConfigurableMap = map[string]bool{
	...
	"Cache.Anycast.AddressManagement": false,
	"Cache.Anycast.Addresses": false,
	"Cache.Anycast.BGP.LocalASN": false,
	"Cache.Anycast.BGP.LocalAddress": false,
	"Cache.Anycast.BGP.Password": false,
	"Cache.Anycast.BGP.PeerASN": false,
	"Cache.Anycast.BGP.PeerAddress": false,
	"Cache.Anycast.BGP.Port": false,
	"Cache.Anycast.BGP.RouterID": false,
	"Cache.Anycast.Device": false,
	"Cache.Anycast.Enable": false,
	"Cache.Anycast.Hostname": false,
	"Cache.Anycast.NextHop": false,
	"Cache.Anycast.ProbeInterval": false,
	"Cache.Anycast.ProbeUrl": false,
	"Cache.Anycast.Routes": false,
...
var stringAccessors = map[string]func(*Config) string{
	"Cache.Anycast.AddressManagement": func(c *Config) string { return c.Cache.Anycast.AddressManagement },
	"Cache.Anycast.BGP.LocalAddress": func(c *Config) string { return c.Cache.Anycast.BGP.LocalAddress },
	"Cache.Anycast.BGP.Password": func(c *Config) string { return c.Cache.Anycast.BGP.Password },
	"Cache.Anycast.BGP.PeerAddress": func(c *Config) string { return c.Cache.Anycast.BGP.PeerAddress },
	"Cache.Anycast.BGP.RouterID": func(c *Config) string { return c.Cache.Anycast.BGP.RouterID },
	"Cache.Anycast.Device": func(c *Config) string { return c.Cache.Anycast.Device },
	"Cache.Anycast.Hostname": func(c *Config) string { return c.Cache.Anycast.Hostname },
	"Cache.Anycast.NextHop": func(c *Config) string { return c.Cache.Anycast.NextHop },
	"Cache.Anycast.ProbeUrl": func(c *Config) string { return c.Cache.Anycast.ProbeUrl },
	...
	"Director.AnycastUrl": func(c *Config) string { return c.Director.AnycastUrl },
...
var stringSliceAccessors = map[string]func(*Config) []string{
	...
	"Cache.Anycast.Addresses": func(c *Config) []string { return c.Cache.Anycast.Addresses },
	"Cache.Anycast.Routes": func(c *Config) []string { return c.Cache.Anycast.Routes },
...
var intAccessors = map[string]func(*Config) int{
	"Cache.Anycast.BGP.LocalASN": func(c *Config) int { return c.Cache.Anycast.BGP.LocalASN },
	"Cache.Anycast.BGP.PeerASN": func(c *Config) int { return c.Cache.Anycast.BGP.PeerASN },
	"Cache.Anycast.BGP.Port": func(c *Config) int { return c.Cache.Anycast.BGP.Port },
...
var boolAccessors = map[string]func(*Config) bool{
	"Cache.Anycast.Enable": func(c *Config) bool { return c.Cache.Anycast.Enable },
	...
	"Client.PreferAnycast": func(c *Config) bool { return c.Client.PreferAnycast },
...
var durationAccessors = map[string]func(*Config) time.Duration{
	"Cache.Anycast.ProbeInterval": func(c *Config) time.Duration { return c.Cache.Anycast.ProbeInterval },
...
var allParameterNames = []string{
	...
	"Cache.Anycast.Addresses",
	"Cache.Anycast.BGP.LocalASN",
	"Cache.Anycast.BGP.LocalAddress",
	"Cache.Anycast.BGP.Password",
	"Cache.Anycast.BGP.PeerASN",
	"Cache.Anycast.BGP.PeerAddress",
	"Cache.Anycast.BGP.Port",
	"Cache.Anycast.BGP.RouterID",
	"Cache.Anycast.Device",
	"Cache.Anycast.Enable",
	"Cache.Anycast.Hostname",
	"Cache.Anycast.NextHop",
	"Cache.Anycast.ProbeInterval",
	"Cache.Anycast.ProbeUrl",
	"Cache.Anycast.Routes",
...
var (
	Cache_Anycast_AddressManagement = StringParam{"Cache.Anycast.AddressManagement"}
	Cache_Anycast_BGP_LocalAddress = StringParam{"Cache.Anycast.BGP.LocalAddress"}
	Cache_Anycast_BGP_Password = StringParam{"Cache.Anycast.BGP.Password"}
	Cache_Anycast_BGP_PeerAddress = StringParam{"Cache.Anycast.BGP.PeerAddress"}
	Cache_Anycast_BGP_RouterID = StringParam{"Cache.Anycast.BGP.RouterID"}
	Cache_Anycast_Device = StringParam{"Cache.Anycast.Device"}
	Cache_Anycast_Hostname = StringParam{"Cache.Anycast.Hostname"}
	Cache_Anycast_NextHop = StringParam{"Cache.Anycast.NextHop"}
	Cache_Anycast_ProbeUrl = StringParam{"Cache.Anycast.ProbeUrl"}
	...
	Director_AnycastUrl = StringParam{"Director.AnycastUrl"}
...
var (
	...
	Cache_Anycast_Addresses = StringSliceParam{"Cache.Anycast.Addresses"}
	Cache_Anycast_Routes = StringSliceParam{"Cache.Anycast.Routes"}
...
var (
	Cache_Anycast_BGP_LocalASN = IntParam{"Cache.Anycast.BGP.LocalASN"}
	Cache_Anycast_BGP_PeerASN = IntParam{"Cache.Anycast.BGP.PeerASN"}
	Cache_Anycast_BGP_Port = IntParam{"Cache.Anycast.BGP.Port"}
...
var (
	Cache_Anycast_Enable = BoolParam{"Cache.Anycast.Enable"}
	...
	Client_PreferAnycast = BoolParam{"Client.PreferAnycast"}
...
var (
	Cache_Anycast_ProbeInterval = DurationParam{"Cache.Anycast.ProbeInterval"}
...
func init() {
	paramByName = map[string]Param{
		"Cache.Anycast.AddressManagement": Cache_Anycast_AddressManagement,
		"Cache.Anycast.BGP.LocalAddress": Cache_Anycast_BGP_LocalAddress,
		"Cache.Anycast.BGP.Password": Cache_Anycast_BGP_Password,
		"Cache.Anycast.BGP.PeerAddress": Cache_Anycast_BGP_PeerAddress,
		"Cache.Anycast.BGP.RouterID": Cache_Anycast_BGP_RouterID,
		"Cache.Anycast.Device": Cache_Anycast_Device,
		"Cache.Anycast.Hostname": Cache_Anycast_Hostname,
		"Cache.Anycast.NextHop": Cache_Anycast_NextHop,
		"Cache.Anycast.ProbeUrl": Cache_Anycast_ProbeUrl,
		...
		"Director.AnycastUrl": Director_AnycastUrl,
		...
		"Cache.Anycast.Addresses": Cache_Anycast_Addresses,
		"Cache.Anycast.Routes": Cache_Anycast_Routes,
		...
		"Cache.Anycast.BGP.LocalASN": Cache_Anycast_BGP_LocalASN,
		"Cache.Anycast.BGP.PeerASN": Cache_Anycast_BGP_PeerASN,
		"Cache.Anycast.BGP.Port": Cache_Anycast_BGP_Port,
		...
		"Cache.Anycast.Enable": Cache_Anycast_Enable,
		...
		"Client.PreferAnycast": Client_PreferAnycast,
		"Debug": Debug,
		...
		"Cache.Anycast.ProbeInterval": Cache_Anycast_ProbeInterval,
