...
var (
	...
	Logging_Cache_Cms = StringParam{"Logging.Cache.Cms"}
	Logging_Cache_Ofs = StringParam{"Logging.Cache.Ofs"}
	Logging_Cache_Pss = StringParam{"Logging.Cache.Pss"}
	Logging_Cache_PssSetOptCache = StringParam{"Logging.Cache.PssSetOptCache"}
	...
	Logging_Origin_PssSetOptOrigin = StringParam{"Logging.Origin.PssSetOptOrigin"}
