...
type configWithType struct {
	Cache struct {
		...
		ClientStatisticsLocation struct {
			Type  string
			Value string
		}
		Concurrency struct {
		...
		ConcurrencyDegradedThreshold struct {
			Type  string
			Value int
		}
		DataLocation struct {
		...
		EnableEvictionMonitoring struct {
			Type  string
			Value bool
		}
		EnableLotman struct {
		...
		EvictionMonitoringInterval struct {
			Type  string
			Value time.Duration
		}
		EvictionMonitoringMaxDepth struct {
			Type  string
			Value int
		}
		...
		MinDirectorRefreshInterval struct {
			Type  string
			Value time.Duration
		}
	...
	Director struct {
		AdaptiveSortEWMATimeConstant struct {
			Type  string
			Value time.Duration
		}
		AdaptiveSortTruncateConstant struct {
			Type  string
			Value int
		}
		AdvertiseUrl struct {
		...
		EnableFederationMetadataHosting struct {
			Type  string
			Value bool
		}
		EnableOIDC struct {
		...
		FilterCachesInErrorState struct {
			Type  string
			Value bool
		}
		...
		MetadataComparisonInterval struct {
			Type  string
			Value time.Duration
		}
	...
	Monitoring struct {
		...
		DataRetentionSize struct {
			Type  string
			Value string
		}
		EnablePrometheus struct {
			Type  string
			Value bool
		}
		LabelLimit struct {
		...
		StorageCriticalThreshold struct {
			Type  string
			Value int
		}
		StorageHealthCheckInterval struct {
			Type  string
			Value time.Duration
		}
		StorageWarningThreshold struct {
			Type  string
			Value int
		}
	...
	Origin struct {
		...
		DiskUsageCalculationDelay struct {
			Type  string
			Value time.Duration
		}
		DiskUsageCalculationInterval struct {
			Type  string
			Value time.Duration
		}
		DiskUsageCalculationRateLimit struct {
			Type  string
			Value int
		}
		EnableAtomicUploads struct {
			Type  string
			Value bool
		}
		EnableBroker struct {
		...
		EnableDiskUsageCalculation struct {
			Type  string
			Value bool
		}
		...
		GlobusTransferTokenFile struct {
			Type  string
			Value string
		}
		...
		SSH struct {
			...
			AutoAddHostKey struct {
				Type  string
				Value bool
			}
			ChallengeTimeout struct {
				Type  string
				Value time.Duration
			}
			...
			PrivateKeyPassphraseFile struct {
				Type  string
				Value string
			}
			ProxyJump struct {
			...
			RemotePelicanBinaryDir struct {
				Type  string
				Value string
			}
			RemotePelicanBinaryOverrides struct {
				Type  string
				Value []string
			}
			SessionEstablishTimeout struct {
				Type  string
				Value time.Duration
			}
			TunnelCallback struct {
				Type  string
				Value bool
			}
			User struct {
		...
		TransferRateLimit struct {
			Type  string
			Value byte_rate.ByteRate
		}
		UploadTempLocation struct {
			Type  string
			Value string
		}
		Url struct {
		...
		UserMapfileRefreshInterval struct {
			Type  string
			Value time.Duration
		}
		XRootDPrefix struct {
	...
	Plugin struct {
		DirectorDecisionPercentage struct {
			Type  string
			Value int
		}
		Token struct {
	...
	Xrootd struct {
		...
		ConfigUpdateFailureTimeout struct {
			Type  string
			Value time.Duration
		}
