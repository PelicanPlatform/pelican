...
func (m *mockServer) CreateAdvertisement(name, serverUrl, serverWebUrl string, availability server_structs.AvailabilityType) (*server_structs.OriginAdvertiseV2, error) {
	return nil, nil
}
