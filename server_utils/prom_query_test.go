...
func TestQueryPrometheus(t *testing.T) {
	...
	t.Run("no-token-query-matrix", func(t *testing.T) {
		parsed, err := QueryMyPrometheus(context.Background(), "matrix")
		require.NoError(t, err)
	...
	t.Run("no-token-query-vector", func(t *testing.T) {
		parsed, err := QueryMyPrometheus(context.Background(), "vector")
		require.NoError(t, err)
	...
	t.Run("no-token-query-scalar", func(t *testing.T) {
		parsed, err := QueryMyPrometheus(context.Background(), "scalar")
		require.NoError(t, err)
	...
	t.Run("no-token-query-string", func(t *testing.T) {
		parsed, err := QueryMyPrometheus(context.Background(), "string")
		require.NoError(t, err)
	...
	t.Run("no-token-query-prom-error", func(t *testing.T) {
		_, err := QueryMyPrometheus(context.Background(), "error")
		assert.Error(t, err)
	...
	t.Run("no-token-query-empty-data", func(t *testing.T) {
		parsed, err := QueryMyPrometheus(context.Background(), "empty")
