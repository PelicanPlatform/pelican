...
func (tc *TransferClient) NewTransferJob(remoteUrl *url.URL, localPath string, engine *TransferEngine, upload bool, recursive bool, options ...TransferOption) (tj *TransferJob, err error) {
