...
-- Revert to single-column primary key on id.
CREATE TABLE IF NOT EXISTS oidc_clients_old (
    id TEXT PRIMARY KEY,
    namespace TEXT NOT NULL DEFAULT '',
    client_secret TEXT NOT NULL,
    redirect_uris TEXT NOT NULL DEFAULT '[]',
...
DROP TABLE oidc_clients;
ALTER TABLE oidc_clients_old RENAME TO oidc_clients;
