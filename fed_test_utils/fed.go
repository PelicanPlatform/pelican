...
func NewFedTest(t *testing.T, originConfig string) (ft *FedTest) {
	...
	require.NoError(t, param.Set(param.Logging_Origin_Cms, "error"))
	require.NoError(t, param.Set(param.Logging_Origin_Xrd, "error"))
	require.NoError(t, param.Set(param.Logging_Origin_Ofs, "error"))
	require.NoError(t, param.Set(param.Logging_Origin_Oss, "error"))
	require.NoError(t, param.Set(param.Logging_Origin_Http, "error"))
	require.NoError(t, param.Set(param.Logging_Origin_Scitokens, "fatal"))
	require.NoError(t, param.Set(param.Logging_Origin_Xrootd, "info"))
	require.NoError(t, param.Set(param.Logging_Cache_Ofs, "error"))
	require.NoError(t, param.Set(param.Logging_Cache_Pss, "error"))
	require.NoError(t, param.Set(param.Logging_Cache_PssSetOpt, "error"))
	require.NoError(t, param.Set(param.Logging_Cache_Http, "error"))
	require.NoError(t, param.Set(param.Logging_Cache_Xrd, "error"))
	require.NoError(t, param.Set(param.Logging_Cache_Xrootd, "error"))
	require.NoError(t, param.Set(param.Logging_Cache_Scitokens, "fatal"))
	...
	require.NoError(t, param.Set(param.TLSSkipVerify, false))

	// Disable functionality we're not using (and is difficult to make work on Mac)
	require.NoError(t, param.Set(param.Registry_DbLocation, filepath.Join(t.TempDir(), "ns-registry.sqlite")))
	...
	require.NoError(t, param.Set(param.Director_FilterCachesInErrorState, false))
	...
	require.NoError(t, param.Set(param.Origin_RunLocation, filepath.Join(tmpPath, "origin")))
	require.NoError(t, param.Set(param.Origin_DbLocation, filepath.Join(t.TempDir(), "origin.sqlite")))
	require.NoError(t, param.Set(param.Origin_TokenAudience, ""))
	require.NoError(t, param.Set(param.Cache_Port, 0))
	require.NoError(t, param.Set(param.Cache_RunLocation, filepath.Join(tmpPath, "cache")))
	require.NoError(t, param.Set(param.Cache_EnableEvictionMonitoring, false))
	require.NoError(t, param.Set(param.Cache_StorageLocation, filepath.Join(tmpPath, "xcache-data")))
	...
	require.NoError(t, param.Set(param.Server_DbLocation, filepath.Join(t.TempDir(), "server.sqlite")))
	...
	require.NoError(t, param.Set(param.LocalCache_RunLocation, filepath.Join(tmpPath, "lc")))
	...
	require.NoError(t, param.Set(param.Federation_DiscoveryUrl, discoveryServer.URL))
