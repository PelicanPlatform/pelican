...
# OA4MP is only for origin. Don't configure it if the daemon is not origin
# the script is expect the argument in "[osdf|pelican] [daemon name] [...args]"
if [ "$2" == "origin" ]; then
    ####
    ...
    ## Set the hostname and OIDC configuration in the proxy-config
