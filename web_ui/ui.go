...
func configureCommonEndpoints(engine *gin.Engine) error {
	...
	engine.GET("/api/v1.0/groups/:id", AuthHandler, AdminAuthHandler, handleGetGroup)
	engine.PATCH("/api/v1.0/groups/:id", AuthHandler, AdminAuthHandler, handleUpdateGroup)
	engine.DELETE("/api/v1.0/groups/:id", AuthHandler, AdminAuthHandler, handleDeleteGroup)
	...
	engine.GET("/api/v1.0/users/:id", AuthHandler, AdminAuthHandler, handleGetUser)
	engine.PATCH("/api/v1.0/users/:id", AuthHandler, AdminAuthHandler, handleUpdateUser)
