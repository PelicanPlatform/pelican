...
type TextFieldProps = Omit<StandardTextFieldProps, "onChange"> & CustomRegistrationFieldProps<string>

interface StringFieldProps extends TextFieldProps {
    validator?: (value: string) => string | undefined;
}

const StringField = ({onChange, displayed_name, name, required, description, value, validator, ...props}: StringFieldProps) => {
