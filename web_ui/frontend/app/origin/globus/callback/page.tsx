      ...
      >
        <Box width={'100%'} textAlign={'center'}>
          <Typography variant='h4' mb={2}>
            Setting up Globus Export...
          </Typography>
          {loading ? (
            <LinearProgress
              color={
                error ? 'error' : nextUrl !== undefined ? 'success' : 'info'
              }
            />
          ) : (
            <LinearProgress
          ...
          )}
          {
            ...
            nextUrl !== undefined && (
              <>
                ...
                <Typography mt={2}>
                  Globus collection is activated. Server is restarting in{' '}
                  {secondsLeft} second...
                </Typography>
                <Typography mt={2} variant='body2'>
                  You will be redirect to the Globus configuration page shortly.
                </Typography>
              </>
            )
          }
