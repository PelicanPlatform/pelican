...
import { ParameterInputProps, Duration } from "@/components/Config/index.d";
...
const VerifiableField = ({onChange, verify, name, description, components, Value}: VerifiableParameter) => {
