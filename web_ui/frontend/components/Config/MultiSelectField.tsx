...
function MultiSelectField<T extends string>({onChange, name, value, possibleValues}: MultiSelectFieldProps<T>){
    ...
    const handleChange = (event: SelectChangeEvent<T[]>) => {
        ...
        const newValue = typeof value === 'string' ? value.split(',') as T[] : value
