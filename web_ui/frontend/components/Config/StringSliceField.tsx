...
import {KeyboardArrowDown, KeyboardArrowUp, KeyboardDoubleArrowDown, Edit, Close} from "@mui/icons-material";
...
const StringSliceField = ({onChange, name, value}: StringSliceFieldProps) => {
    ...
    const handleKeyDown = useCallback((event: KeyboardEvent) => {
        ...
        if(event.key == "Enter" && event.target instanceof HTMLInputElement && event.target.value != "") {
            const newValue = [...(new Set<string>([...localValue, event.target.value]))].sort(stringSort)
