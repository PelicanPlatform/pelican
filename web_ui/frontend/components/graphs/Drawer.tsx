      ...
      <Grid item xs={12} md={6}>
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={(e) =>
              setDuration(
                new TimeDuration(e.target.value as number, duration.type)
              )
            }
          >
      ...
      <Grid item xs={6}>
        <FormControl fullWidth>
          <TextField
            ...
            value={rate.value}
            onChange={(e) =>
              setRate(new TimeDuration(parseInt(e.target.value), rate.type))
            }
          ></TextField>
        </FormControl>
      </Grid>
      <Grid item xs={5}>
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={(e) =>
              setRate(
                new TimeDuration(rate.value, e.target.value as DurationType)
              )
            }
          >
      ...
      <Grid item xs={6}>
        <FormControl fullWidth>
          <TextField
            ...
            onChange={(e) =>
              setResolution(
                new TimeDuration(parseInt(e.target.value), resolution.type)
              )
            }
          ></TextField>
        </FormControl>
...
function GraphDrawer({
  ...
  return (
    <Paper
      elevation={drawerOpen ? 1 : 0}
      sx={{
        display: 'flex',
        flexGrow: 1,
        flexDirection: 'column',
        transition: 'all 0.5s ease',
        backgroundColor: drawerOpen ? '#fff' : '#fff0',
      }}
    >
      ...
      <Box>
        ...
        <DrawerBox hidden={graphSettingsHidden}>{children}</DrawerBox>
      </Box>
    </Paper>
  );
}
