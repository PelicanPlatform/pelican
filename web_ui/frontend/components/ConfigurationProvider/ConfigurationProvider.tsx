...
import {ParameterValueRecord, submitConfigChange} from "@/components/configuration";
...
export const ConfigurationContext = createContext<ConfigurationContextState>({
	...
	merged: {},
	patch: {},
	setPatch: () => {console.error("setPatch not set")},
	mutate: () => {console.error("mutate not set")},
	submit: async () => {
...
export const ConfigurationProvider = ({ children }: { children: React.ReactNode }) => {
	...
	const submit = useCallback(async () => {
		...
		console.log("Submitted and Continued")
