...
func (server *CacheServer) CreateAdvertisement(name, originUrl, originWebUrl string, availability server_structs.AvailabilityType) (*server_structs.OriginAdvertiseV2, error) {
