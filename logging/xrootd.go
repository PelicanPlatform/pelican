...
// DetectXrootdLoggingChange reports
// whether any XRootD logging parameters differ between oldConfig and newConfig,
// indicating that a restart
// of the XRootD origin or cache daemon
...
// whether the parameter is an XRootD logging parameter
// that might require a restart when changed.
// If not,
// the returned config is nil and the boolean is false.
